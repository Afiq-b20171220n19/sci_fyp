    ...
    $result = mysqli_query($conn, $sql) or die(mysqli_error($conn));
        ...
        while($row = mysqli_fetch_array($result)) { 
          ...
          $ptitle = $row['project_title'];
           ...
           $query0 = "SELECT student_id, student_name, programme_area FROM student_db WHERE student_id = '$lid'";
    ...
    ?>
        ...
        <tr>
         ...
         <tr>   
           ...
           <tr>   
            <td>
               <b>Intake:</b>&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;<?php  { print $ptitle; }?>
            </td>
           </tr> 
           <tr> 
            <td>
    ...
    <div class="main">
        <form action="" method="post">
           ...
           <!--      <?php
                ...
                <input type="text" name="p2" id="" placeholder="Enter Marks for BACKGROUND STUDY (Well investigated) further refined, progress from proposal">
                <input type="text" name="p3" id="" placeholder="Enter Marks for PROPOSED SOLUTION (JUSTIFIED) further refined progress from proposal">
                <input type="text" name="p4" id="" placeholder="Enter Marks for ANALYSIS (futher refined)">
                ...
                <input type="text" name="p7" id="" placeholder="Enter Marks for PRESENTATION">
  ...
  if(isset($_POST['projt'],$_POST['p1'],$_POST['p2'],$_POST['p3'],$_POST['p4'],$_POST['p5'],$_POST['p6'],$_POST['p7']))
    {
        ...
        $marks=2/100*$p1*10+20/100*$p2*10+28/100*$p3*10+30/100*$p4*10+10/100*$p5*10+5/100*$p6+5/100*$p7;
       // $percentage=$marks/5;
