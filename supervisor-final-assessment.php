    ...
    <div class="main">
        <form action="" method="post">
           ...
           <!--      <?php
                ...
                <input type="text" name="p1" id="" placeholder="Enter Marks for DEVELOPMENT PROCESS">
                <input type="text" name="p2" id="" placeholder="Enter Marks for FINDINGS & CRITICAL EVALUATION">
                <input type="text" name="p3" id="" placeholder="Enter Marks for REPORT">
                <input type="text" name="p4" id="" placeholder="Enter Marks for COMPLETION (BONUS)">
                <input type="text" name="p5" id="" placeholder="Enter Marks for PRESENTATION & POSTER">
  ...
  if(isset($_POST['projt'],$_POST['p1'],$_POST['p2'],$_POST['p3'],$_POST['p4'],$_POST['p5'],$_POST['p6'],$_POST['p7']))
    {
        ...
        $marks=30/100*$p1*10+30/100*$p2*10+20/100*$p3*10+10/100*$p4*10+10/100*$p5;
       // $percentage=$marks/5;
