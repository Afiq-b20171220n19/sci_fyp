...
<html>
  <?php 
    ...
    include "../sci/includes/student-navbar.php";
...
<div class="container">
    <div class="row">
      ...
      <h1>List of My Projects (STUDENT)</h1>
      <hr>
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        else
                        {
                         ...
                         $select = "SELECT student_id, student_name FROM student_db WHERE student_id = '$myid'";
                         $res = mysqli_query($conn, $select);

                         while($getting = mysqli_fetch_array($res))
                         {
                            $stuid = $getting['student_id'];
                            $stuname = $getting['student_name'];
                         }

                          $query = "
                          SELECT DISTINCT allocation_id, project_id, student_roll_number, student_id, first_supervisor_id, second_supervisor_id FROM allocation_project WHERE first_supervisor_id = '$stuname' OR first_supervisor_id = '$stuid' OR second_supervisor_id = '$stuid'";
                                    ...
                                    <div class="btn-group">
                                      ...
                                      <ul class="dropdown-menu" role="menu">
                                        ';
                                          ...
                                          $output .= '
                                            <li>
                                              <a href="student-feedback.php?id=' . $proj . '">view feedback</a>
