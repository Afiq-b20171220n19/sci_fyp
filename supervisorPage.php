...
<div class="container">
    <div class="row">
      ...
      <h1>List of Projects</h1>
       <button type="button" class="btn btn-primary"><a href="../sci/assessed-project.php">View My Assessed Projects</a></button>
                 ...
                 <tbody>
                   <?php
                        ...
                        else
                        {
                         ...
                         $select = "SELECT staff_id, name FROM user WHERE username = '$leader'";
                         $res = mysqli_query($conn, $select);

                         while($getting = mysqli_fetch_array($res))
                         {
                            $leaderid = $getting['staff_id'];
                            $leadername = $getting['name'];
                         }

                          $query = "
                          SELECT DISTINCT allocation_id, project_id, student_roll_number, student_id, first_supervisor_id, second_supervisor_id FROM allocation_project WHERE first_supervisor_id = '$leadername' OR first_supervisor_id = '$leaderid' OR second_supervisor_id = '$leaderid'";
                                    ...
                                    <div class="btn-group">
                                      ...
                                      <ul class="dropdown-menu" role="menu">
                                        ';
                                          ...
                                          $output .= '
                                            <li>
                                              <a href="supervisor-proposal-assessment.php?id=' . $proj . '">Assess Proposal</a>
                                              <a href="supervisor-interim-assessment.php?id=' . $proj . '">Assess interim</a>
                                              <a href="supervisor-final-assessment.php?id=' . $proj . '">Assess Final</a>
                                            </li>';
                                        }
